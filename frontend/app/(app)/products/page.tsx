    ...
    <div className="flex h-full flex-col gap-4">
      ...
      <div className="glass flex min-h-0 flex-1 flex-col rounded-3xl p-5">
        <div className="flex items-center gap-3 pb-4">
          ...
          <div className="flex-1" />
          <button disabled title="Скоро" className="flex items-center gap-2 rounded-xl border border-white/70 bg-white/60 px-3.5 py-2 text-[12.5px] font-medium text-muted opacity-60">
