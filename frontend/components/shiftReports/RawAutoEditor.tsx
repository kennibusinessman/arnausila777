 ...
 * «Сырьё Дастархан» (по умолчанию) + любой спанбонд. Для простыней/дастархана слот помечен
 * `multi` — можно указать несколько строк сырья кнопкой «Добавить сырьё». Мастер указывает
 * только расход — отхода у сырья нет.
 */
